    ...
    require(
        ...
        function (ec, limitless) {
            ...
            lasagna_donut_options = {
                ...
                // Add title
                title: {
                    text: 'Conrtact type distribution',
                ...
                options: [
                    {
                        ...
                        legend: {
                            x: 'left',
                            orient: 'vertical',
                            data: ['Digital Mailroom', 'Data Capture', 'DMS', 'Data Insights', 'Digital Signature']
                        },
                        ...
                        series: [{
                            ...
                            radius: '60%',
                            data: [
                                { value: idx * 128 + 80, name: 'Digital Mailroom' },
                                { value: idx * 64 + 160, name: 'Data Capture' },
                                { value: idx * 32 + 320, name: 'DMS' },
                                { value: idx * 16 + 640, name: 'Data Insights' },
                                { value: idx++ * 8 + 1280, name: 'Digital Signature' }
                            ]
                        }]
                    },
...
$(function () {
    ...
    // Initialize charts
    progressCounter('#delivery_delayed_widget', 38, 2, "#F06292", 0.11, "icon-watch text-pink-400", 'Delivery failure', '6 Contracts')
    progressCounter('#ontime_widget', 38, 2, "#5C6BC0", 0.68, "icon-trophy3 text-indigo-400", 'Delivered on time', '130 Contracts')
